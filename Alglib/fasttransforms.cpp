     ...
     ae_state *_state)
{
    ...
    ae_vector_init(&fh, 0, DT_COMP, _state);
     ...
     ae_state *_state)
{
    ...
    ae_frame_make(_state, &_frame_block);
    ae_vector_clear(c);
    ae_vector_init(&buf, 0, DT_COMP, _state);
     ...
     ae_state *_state)
{
    ...
    ae_vector_init(&buf, 0, DT_REAL, _state);
    ae_vector_init(&buf2, 0, DT_REAL, _state);
    ae_vector_init(&cbuf, 0, DT_COMP, _state);
    _fasttransformplan_init(&plan, _state);
     ...
     ae_state *_state)
{
    ...
    ae_vector_init(&buf3, 0, DT_REAL, _state);
    ae_vector_init(&cbuf, 0, DT_COMP, _state);
    ae_vector_init(&cbuf2, 0, DT_COMP, _state);
    _fasttransformplan_init(&plan, _state);
     ...
     ae_state *_state)
{
    ...
    ae_frame_make(_state, &_frame_block);
    ae_vector_clear(r);
    ae_vector_init(&bbuf, 0, DT_COMP, _state);
    _fasttransformplan_init(&plan, _state);
    ae_vector_init(&buf, 0, DT_REAL, _state);
    ae_vector_init(&buf2, 0, DT_REAL, _state);
     ...
     ae_state *_state)
{
    ...
    ae_frame_make(_state, &_frame_block);
    ae_vector_clear(r);
    ae_vector_init(&p, 0, DT_COMP, _state);
    ae_vector_init(&b, 0, DT_COMP, _state);
...
void fhtr1d(/* Real    */ ae_vector* a, ae_int_t n, ae_state *_state)
{
    ...
    ae_frame_make(_state, &_frame_block);
    ae_vector_init(&fa, 0, DT_COMP, _state);
