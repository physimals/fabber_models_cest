     ...
     ae_state *_state)
{
    ...
    *info = 0;
    _densesolverreport_clear(rep);
    ae_matrix_clear(x);
    ae_matrix_init(&da, 0, 0, DT_COMP, _state);
    ae_matrix_init(&emptya, 0, 0, DT_COMP, _state);
    ae_vector_init(&p, 0, DT_INT, _state);
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    _densesolverreport_clear(rep);
    ae_vector_clear(x);
    ae_matrix_init(&bm, 0, 0, DT_COMP, _state);
    ae_matrix_init(&xm, 0, 0, DT_COMP, _state);
     ...
     ae_state *_state)
{
    ...
    *info = 0;
    _densesolverreport_clear(rep);
    ae_matrix_clear(x);
    ae_vector_init(&xc, 0, DT_COMP, _state);
    ae_vector_init(&y, 0, DT_COMP, _state);
    ae_vector_init(&bc, 0, DT_COMP, _state);
    ae_vector_init(&xa, 0, DT_COMP, _state);
    ae_vector_init(&xb, 0, DT_COMP, _state);
    ae_vector_init(&tx, 0, DT_COMP, _state);
